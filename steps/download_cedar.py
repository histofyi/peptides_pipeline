...
def download_cedar(**kwargs):
    """
    This function downloads the MHC peptide epitope data dump from the CEDAR resource (cancer epitope database from IEDB).

    """

    datasource_key = 'cedar'
